...
import static seedu.address.logic.commands.CommandTestUtil.COMPANY_DESC;
...
public class EditCommandSystemTest extends AddressBookSystemTest {
    ...
    public void edit() throws Exception {
         ...
         * -> edited
         */
        Index index = INDEX_THIRD_PERSON;
        String command = " " + EditCommand.COMMAND_WORD + "  " + index.getOneBased() + "  " + NAME_DESC_BOB + "  "
                + PHONE_DESC_BOB + " " + EMAIL_DESC_BOB + "  " + ADDRESS_DESC_BOB + " " + TAG_DESC_HUSBAND
                + "  " + COMPANY_DESC_BOB + "  " + POSITION_DESC_BOB + "  " + PRIORITY_DESC_BOB;
        Person editedPerson = new PersonBuilder().withName(VALID_NAME_BOB).withPhone(VALID_PHONE_BOB)
            ...
            .withPosition(VALID_POSITION_BOB).withPriority(VALID_PRIORITY_BOB).withCompany(VALID_COMPANY_BOB).build();
        ...
        model.updatePerson(
            getModel().getFilteredPersonList().get(INDEX_THIRD_PERSON.getZeroBased()), editedPerson);
        assertCommandSuccess(command, model, expectedResultMessage);

        /* Case: edit a person with new values same as existing values -> edited */
        command = EditCommand.COMMAND_WORD + " " + index.getOneBased() + NAME_DESC_BOB + PHONE_DESC_BOB
            + EMAIL_DESC_BOB + ADDRESS_DESC_BOB + TAG_DESC_FRIEND + TAG_DESC_HUSBAND + COMPANY_DESC + POSITION_DESC
            + PRIORITY_DESC;
